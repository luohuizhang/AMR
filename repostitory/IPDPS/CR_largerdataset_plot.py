...
namelist=["G1","G2","G3\n638MB/timestep","G4","G5","G6","G1","G2","G3\n4911MB/timestep","G4","G5","G6"]
#xticks_minor = [-0.3,  5.7, 11.7,17.8 ]
xticks_minor = [-0.3,  5.7, 11.7 ]
...
plt.savefig(name_hat+'CR_ZFP_largerdataset_Scaling.pdf', format='pdf',bbox_inches="tight",pad_inches=0)
plt.show()
...
plt.savefig(name_hat+'CR_SZ_largerdataset_Scaling.pdf', format='pdf',bbox_inches="tight",pad_inches=0)
plt.show()
...
plt.savefig(name_hat+'CR_largerdataset_Scaling.pdf', format='pdf',bbox_inches="tight",pad_inches=0)
plt.show()
