...
sed -i "7s/.*/#define Level 5/" ../repostitory/reordering_gilbert.c
make -f Makefile
...
sed -i "7s/.*/#define Level 6/" ../repostitory/reordering_gilbert.c
make -f Makefile
cd ../Greenland
echo Greenland
